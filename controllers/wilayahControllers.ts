...
// get all wilayah
export const getAllWilayah = asyncHandler(async (req: any, res: Response) => {
    const responseData = (res as any).advancedResults;
    res.status(200).json({
        success: responseData.success,
        wilayah: responseData.data,
        pagination: responseData.pagination
    })
})

// get by id wilayah
export const getByIdWilayah = asyncHandler(async (req: any, res: Response, next: NextFunction) => {
...
// add Wilayah
export const createWilayah = asyncHandler(async (req: any, res: Response, next: NextFunction) => {
...
// Update wilayah
export const updateWilayah = asyncHandler(async (req: any, res: Response, next: NextFunction) => {
...
// delete wilayah
export const deleteWilayah = asyncHandler(async (req: any, res: Response) => {
