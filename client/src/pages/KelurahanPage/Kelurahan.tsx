...
import { deleteKelurahan, listKelurahan } from '@/entities/kelurahan/model/kelurahanActions';
import { KELURAHAN_CREATE_RESET } from '@/entities/kelurahan/model/kelurahanConstants';
...
const Kelurahan = ({ history }) => {
    ...
    const { loading, error, kelurahan, pagination } = useSelector((state: any) => state.kelurahanList);
    ...
    const handleTableChange = (type, { page, sizePerPage, searchText }) => {
        dispatch(listKelurahan(page, sizePerPage, searchText || ''));
    }
