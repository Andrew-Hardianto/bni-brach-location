...
import KotaModel from '../models/Kota';
import KecamatanModel from '../models/Kecamatan';
import KelurahanModel from '../models/Kelurahan';
import KodeposModel from '../models/Kodepos';
import WilayahModel from '../models/Wilayah';
import CabangModel from '../models/Cabang';
...
db.Provinsi = ProvinsiModel(sequelize, Sequelize);
db.Kota = KotaModel(sequelize, Sequelize);
db.Kecamatan = KecamatanModel(sequelize, Sequelize);
db.Kelurahan = KelurahanModel(sequelize, Sequelize);
db.Kodepos = KodeposModel(sequelize, Sequelize);
db.Wilayah = WilayahModel(sequelize, Sequelize);
db.Cabang = CabangModel(sequelize, Sequelize);
db.Outlet = OutletModel(sequelize, Sequelize);
